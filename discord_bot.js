...
var commands = {
	...
	*/
    ...
    "prefixes": {
        description: 'Tells you all the bot prefixes',
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "```\nAetherBot = - \nAika = ! \nAika Music = ~ \nBooBot = ~ \ngenesis = / \nLapzbot = ? \nMiki = > \nOne Punch Bot = $\n```");
        }
    },
    "joinme": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "https://www.join.me/start");
        }
    },
    "animus": {
    ...
    "refresher": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "`Here are the commands you need to know as a member of staff` \nhttp://animus.site88.net/staffcmds.html");
        }
    },
    "rules": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "`Here are Animus' Rules` \nhttp://animus.site88.net/rules.html");
        }
    },
    "w_profilepic": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "Your profile picture breaks the rules of Animus and therefore. On behalf of the staff I must tell you to change it. Please do so with great haste, as if you fail to comply within an acceptable timeframe. You could face a ban.");
        }
    },
    "w_porn": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "I am sending this message to inform you that you have posted something. That is breaking rule 5 of Animus (no pornographic material). Please remove your message if it has not already been removed. Also please do not send anymore messages that break the rules of Animus. If you continue to do so you could face a ban. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
        }
    },
    "w_ecchi": {
		process: function(bot, msg, suffix) {
				bot.sendMessage(msg.channel, "I am sending this message to inform you that you have posted something. That is breaking rule 4 of Animus (no ecchi material). Please remove your message if it has not already been removed. Also please do not send anymore messages that break the rules of Animus. If you continue to do so you could face a ban. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
		}
		
    },
    "w_spam": {
		process: function(bot, msg, suffix) {
				bot.sendMessage(msg.channel, "I am sending this message to inform you that you have posted something. That is breaking rule 9 of Animus (no spamming). Please do not spam or send anymore messages that break the rules of Animus. If you continue to do so you could face a ban. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
		}
    },
    "w_racist": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "I regret to inform you that you have been found to be racist. In one of the Animus channels. If you continue to be racist you will be banned. As it is against the rules. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
        }
    },
    "w_abuse": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "You have been reported to the staff for being abusive towards a member of Animus. Please stop the abusive behaviour immediately or you will be banned. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
        }
    },
    "w_harass": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "You have been reported to the staff for harassing a member of Animus. Please stop the harassment immediately or you will be banned. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
        }
    },
    "w_exploit": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "You have been reported to the staff for exploiting something you shouldn't have. Please stop exploiting any bot commands and/or whatever else. If you do not stop you could face a ban. If you think you have been wrongly accused/charged. You may talk to a member of staff about it.");
        }
    },
    "w_wrongstaff": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "Please refrain from mentioning a higher staff member such as the one you have just mentioned. Instead please go to a lower staff member (Starting from Moderator). Then work your way up, thank you :)");
        }
    },
    "w_nodev": {
        process: function(bot, msg, suffix) {
            bot.sendMessage(msg.channel, "Please refrain from asking a developer for help. They are not technically counted as a member of staff. So please go to a Moderator, Admin etc. Thank you :)");
        }
    },
        ...
        if (cmdTxt === "help") {
            ...
            bot.sendMessage(msg.author, "Available Commands:", function() {
                for (var cmd in commands) {
                    ...
                    if (cmd.startsWith('refreshe')) {

                    } else {
                        if (cmd.startsWith('w_exploi')) {

                        } else {
                            if (cmd.startsWith('w_racis')) {

                            } else {
                                if (cmd.startsWith('w_por')) {

                                } else {
                                    if (cmd.startsWith('w_profilepi')) {

                                    } else {
                                        if (cmd.startsWith('w_ecch')) {

                                        } else {
                                            if (cmd.startsWith('w_abus')) {

                                            } else {
                                                if (cmd.startsWith('w_haras')) {

                                                } else {
                                                    if (cmd.startsWith('pin')) {

                                                    } else {
                                                        if (cmd.startsWith('w_wrongstaf')) {

                                                        } else {
                                                            if (cmd.startsWith('w_node')) {
